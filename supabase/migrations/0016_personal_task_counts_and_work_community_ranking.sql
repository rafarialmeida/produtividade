-- Dois ajustes:
-- 1) As legendas do ranking individual do Muro Global ("X tarefas concluídas"
--    / "X tarefas perdidas") precisam contar só tarefas fora de comunidades
--    de Trabalho, senão uma tarefa de trabalho aparece na legenda mesmo sem
--    contar pontos (personal_positive_points/personal_lost_points já
--    ignoravam, mas as contagens de tarefas ainda eram combinadas).
-- 2) O "ranking de comunidade" dentro de uma comunidade de Trabalho deve
--    comparar a comunidade como um todo contra as demais comunidades de
--    Trabalho da plataforma (igual ao ranking de comunidades de Competição
--    no Muro Global), não ranquear os membros de dentro dela.
...
-- membros individualmente) — análogo ao competition_community_rankings(),
-- mas para o tipo "trabalho". Usado dentro da própria comunidade (aba
-- "Ranking", ao lado do Tabuleiro) pra comparar com as demais comunidades de
-- trabalho da plataforma. Visível a qualquer autenticado, mesmo sem ser
-- membro de todas elas.
